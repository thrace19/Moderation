  ...
  if (prefixRegex.test(message.content)) {
    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m SpecialBot. Need help?')
        ...
        .addField('Invite Me', oneLine`
          ...
          [here](https://discordapp.com/oauth2/authorize?client_id=512712219398766613&scope=bot&permissions=403008599)!
        `)
        .addField('Support', oneLine`
          If you have questions, suggestions, or found a bug, please join the 
          [SpecialBot Support Server](https://discord.gg/NPhPsqWp)!
        `)
        .setFooter('DM DaddyGamal..#2002 to speak directly with the developer!')
