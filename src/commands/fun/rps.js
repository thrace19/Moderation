...
module.exports = class RockPaperScissorsCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Play a game of rock–paper–scissors against Ezex!',
  ...
  run(message, args) {
    ...
    else if (botChoice > userChoice || botChoice === 0 && userChoice === 2) result = '**Ezex** wins!';
    else result = `**${message.member.displayName}** wins!`;
    const embed = new MessageEmbed()
      .setTitle(`${message.member.displayName} vs. Ezex`)
      .addField('Your Choice:', res[userChoice], true)
      .addField('Ezex\'s Choice', res[botChoice], true)
