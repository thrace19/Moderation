...
module.exports = class FeedbackCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Sends a message to the SpecialBot Support Server feedback channel.',
      type: client.types.MISC,
      examples: ['feedback We love SpecialBot!']
    });
  }
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [SpecialBot Support Server](https://discord.gg/4cxvzSemCq) to further discuss your feedback.
      `) 
