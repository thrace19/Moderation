...
module.exports = class ReportBugCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
        Sends a message to the SpecialBot Support bug report channel.
  ...
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(oneLine`
        ...
        Please join the [SpecialBot Support Server](https://discord.gg/4cxvzSemCq) to further discuss your issue.
        Additionally.
      `) 
