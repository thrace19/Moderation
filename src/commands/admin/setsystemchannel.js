...
module.exports = class SetSystemChannelCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: oneLine`
        Sets the system text channel for your server. This is where Ezex's system messages will be sent. 
        Provide no channel to clear the current \`system channel\`. Clearing this setting is **not recommended** 
        as Ezex requires a \`system channel\` to notify you about important errors.
      `,
